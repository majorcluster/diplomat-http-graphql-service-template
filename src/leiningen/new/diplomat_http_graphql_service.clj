(ns leiningen.new.diplomat-http-graphql-service
  (:require [leiningen.new.templates :as tmpl]
            [leiningen.core.main :as main]))

(def render (tmpl/renderer "diplomat_http_graphql_service"))

(defn diplomat-http-graphql-service
  [name]
  (let [main-ns (tmpl/sanitize-ns name)
    ...
    (main/info "Generating fresh 'lein new' diplomat-http-graphql-service project.")
    (tmpl/->files data
                  ...
                  ["resources/schemas/foo.edn" (render "resources_foo.edn" data)]
